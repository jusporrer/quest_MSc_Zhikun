...
jsPsych.plugins['survey-multi-choice'] = (function() {
      ...
      plugin.trial = function(display_element, trial) {
            ...
            html += ".jspsych-survey-multi-choice-question { margin-top: 2em; margin-bottom: 2em; margin-left: 3em; text-align: left; }"+
            ".jspsych-survey-multi-choice-text span.required {color: darkred;}"+
            ".jspsych-survey-multi-choice-horizontal .jspsych-survey-multi-choice-text {  text-align: left;}"+
            ".jspsych-survey-multi-choice-preamble {margin-top: 3em; margin-bottom: 3em; margin-left: 3em; text-align: left;}"+
            ".jspsych-survey-multi-choice-option { line-height: 2; }"+
            "."+plugin_id_name+" {margin-top: 3em; margin-bottom: 3em; margin-left: 3em;}"+
