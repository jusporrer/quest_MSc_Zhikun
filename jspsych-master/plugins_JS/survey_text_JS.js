                  ...
                  questions: {
                        ...
                        nested: {
                              ...
                              options: {
                                    ...
                                    pretty_name: 'Options question',
                                    default: [],
                                    description: 'Possible options to select'
                              }
                        }
                  },
                  preamble: {
      ...
      plugin.trial = function(display_element, trial) {
            ...
            for (var i = 0; i < trial.questions.length; i++) {
                  ...
                  if(question.options.length > 0 ){
                        html += '<select id="input-'+question_index+'" name="#jspsych-survey-text-response-' + question_index + '" data-name="'+question.name+'" '+autofocus+' '+req+' placeholder="'+question.placeholder+'" style="width: 300px; height: 40px"> '; //
                        ...
                        html += '<textarea id="input-'+question_index+'" name="#jspsych-survey-text-response-' + question_index + '" data-name="'+question.name+'" '+autofocus+' '+req+' placeholder="'+question.placeholder+'" style="width: 300px; height: 40px"></textarea>';
                  }
                  html += '</div>';
            }
            ...
            display_element.querySelector('#jspsych-survey-text-form').addEventListener('submit', function(e) {
                  ...
                  for(var index=0; index < trial.questions.length; index++){
                        var id = "Q" + index;
                        if(trial.questions[question_order[index]].options.length > 0 ){
                              var q_element = document.getElementById('input-'+index+'');
                              var val = q_element.options[q_element.selectedIndex].value;
                        } else {
